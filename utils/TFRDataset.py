...
def read_tfrecord(example, timesteps=64, height=64, width=64):
    features = {
...
def tfr_data_loader(data_dir="", batch_size=32, drop_remainder=True, shuffle_buffer=1000, timesteps=64, height=64, width=64):
    '''
